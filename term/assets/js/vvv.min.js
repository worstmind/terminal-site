    ...
    if (e.keyCode == 9) {
      ...
      switch (cmd) {
        case 'ls':
          ...
          break;
        case 'socials':
              output("choose a number <br><br>[1] instagram <br>[2] twitter <br>[3] github");
        break;     
          case '1':
          window.open("https://instagram.com/bargeeel", "_blank");                    
          break;
          case '2':
          window.open("https://twitter.com/frostyoungboy", "_blank");                    
          break;
          case '3':
          window.open("https://github.com/frostboyz", "_blank");                    
          break;
        case 'play':
